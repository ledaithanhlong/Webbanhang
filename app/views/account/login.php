          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="/webbanhang/account/checklogin" method="post">
                  <?php if (isset($errors)): ?>
                    <ul>
                  ...
                  <p class="text-center">
                    Chưa có tài khoản? <a href="/webbanhang/account/register" class="text-decoration-none">Đăng ký</a>
                  </p>
                </form>
              </div>
